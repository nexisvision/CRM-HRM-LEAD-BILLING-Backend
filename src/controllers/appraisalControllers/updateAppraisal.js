...
export default {
    ...
    handler: async (req, res) => {
        try {
            ...
            await appraisal.update({ employee, branch, department, designation, businessProcess, oralCommunication, leadership, projectManagement, allocatingResources, overallRating, updated_by: req.user?.username });
